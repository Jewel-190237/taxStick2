...
const TaxPlan = () => {
    const taxPlanData = [
        ...
        { image: '/plan/personal.svg', heading: 'personal tax', title: 'There are many variations of the passage available; the majority have suffered alteration.' },
        { image: '/plan/ins.svg', heading: 'insurance tax', title: 'There are many variations of the passage available; the majority have suffered alteration.' },
